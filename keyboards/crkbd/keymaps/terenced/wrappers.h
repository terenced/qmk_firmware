...
#define ______________COLEMAK_MOD_DH_L2____________ CM_A , CM_R , CM_S    , CM_T   , CM_G
#define ______________COLEMAK_MOD_DH_L3____________ KC_Z , KC_X , KC_C    , KC_D   , KC_V

#define ______________COLEMAK_MOD_DH_R1____________ KC_J , KC_L , KC_U    , KC_Y   , KC_SCLN
#define ______________COLEMAK_MOD_DH_R2____________ CM_M , CM_N , CM_E    , CM_I   , CM_O
...
#define ________________NAV_R1_____________________ _______ , U_CPY   , U_CPY   , U_PST   , U_CMPST  
...
#define ________________ADJUST_L1__________________ _______ , _______, _______, _______, BL_TOGG
#define ________________ADJUST_L2__________________ _______ , _______, _______, _______, BL_STEP
...
#define ________________ADJUST_RR__________________ _______ , _______ , _______ , _______ , _______
// clang-format on
